...
{
    // Mengambil role asli dari user yang sedang login
    ...
    public function index(Request $request)
    {
        ...
        // Mengambil daftar barang diurutkan berdasarkan kolom 'name'
    ...
    public function store(Request $request)
    {
        ...
        ProductionOrder::create([
            ...
            'produk' => $inventory->name, // Mengambil nama dari kolom 'name' di tabel items
    ...
    // --- FITUR OPERASIONAL (ADMIN) + OTOMATIS POTONG STOK INVENTORY ---
    public function submitMaterialRequest(Request $request, $id) 
    {
        ...
        try {
            ...
            // Ambil data item inventory yang terikat dengan SPK ini
            $inventoryItem = Item::find($order->inventory_id);

            if ($inventoryItem) {
                // Cek apakah stok di inventory mencukupi kebutuhan produksi
                ...
                // KURANGI STOK INVENTORY SECARA OTOMATIS
