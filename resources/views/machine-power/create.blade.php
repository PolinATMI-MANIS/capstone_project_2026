...
<div class="row justify-content-center">
    <div class="col-md-8">
        <div class="d-flex align-items-center mb-4">
            ...
            <div>
                <h2 class="fw-bold text-dark mb-0" style="font-size: 1.4rem;">Add New Machine</h2>
                <p class="text-muted small mb-0">Daftarkan mesin baru ke dalam sistem industri.</p>
            </div>
        </div>

        <div class="card border-0 shadow-sm rounded-4 bg-white p-4">
            <form action="{{ route('machine-power.store') }}" method="POST" enctype="multipart/form-data">
                @csrf
                ...
                <div class="mb-3">
                    ...
                    <input type="text" class="form-control @error('machine_type') is-invalid @enderror" id="machine_type" name="machine_type" value="{{ old('machine_type') }}" required>
                    @error('machine_type')
                        <div class="invalid-feedback">{{ $message }}</div>
                    @enderror
                </div>
                ...
                <div class="row">
                    ...
                    <div class="col-md-6 mb-3">
                        ...
                        <input type="text" class="form-control @error('capacity') is-invalid @enderror" id="capacity" name="capacity" value="{{ old('capacity') }}" required>
                        @error('capacity')
                            <div class="invalid-feedback">{{ $message }}</div>
                        @enderror
                    </div>
                ...
                <div class="d-flex justify-content-end gap-2">
                    ...
                    <button type="submit" class="btn text-dark fw-bold px-4" style="background-color: #ffcc00; border-radius: 8px;">Save Machine</button>
                </div>
            </form>
        </div>
    </div>
